...
@dataclass
class Email:
    """Модель письма с полями и методами обработки."""
    subject: str
    body: str
    sender: EmailAddress
